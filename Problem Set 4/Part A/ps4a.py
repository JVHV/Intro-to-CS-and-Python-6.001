    ...
    while z != 0: 
        ...
        #6
            ...
            if isValidWord(word, hand, wordList) == True:
                ...
                print ('"',word,'"', "earned", getWordScore(word, n), "points. Total:",total_score,"points")  # "Create total score"
...
def playGame(wordList):
    ...
    while UserWish != "e": 
        ...
        UserWish= input("Enter n to deal a new hand, r to replay the last hand, or e to end game:") 
